...
jQuery( function ( $ )
{
	...
	{
		var $clones = $el.closest( '.mashsb-rwmb-clone' ).siblings( '.mashsb-rwmb-clone' ),
			id = '';
		$clones.each( function ()
		{
			var currentId = $( this ).find( '.mashsb-rwmb-wysiwyg' ).attr( 'id' );
	...
	$( '.mashsb-rwmb-input' ).on( 'clone', ':input.mashsb-rwmb-wysiwyg', update );
} );
